...
function actionNameFunction(a, b, c) {
    if (a === b) {
        return 'equal'
    } else {
        return 'notEqual'
...
const sun = actionNameFunction(1, 2, 3)
console.log(sun)
actionNameFunction(1, 2, 3)
actionNameFunction(1, 2, 3)

//function Expression
const actionNameFunction = function (a, b, c) {
    if (a === b) {
        return 'equal'
    } else {
        return 'notEqual'
...
//function Arrow
const arrowFunction = (a, b, c) => a !== b || b === c

console.log(arrowFunction(1,5,6, 7, 8,9,10))

[1,2,3,4,5].map((element) => element) // [1,2,3,4,5]

[1,2,3].forEach(element => console.log(1));

function myForEach(callback) {
    callback(123)
}

myForEach(element => console.log(element))
