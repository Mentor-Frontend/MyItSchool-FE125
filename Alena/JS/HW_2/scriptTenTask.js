...
if (dayTenTask >= 32 && dayTenTask < 60) {
    document.writeln('Это февраль.', '<br/>');
    month = 2;
}
if (dayTenTask >= 60 && dayTenTask < 91) {
    document.writeln('Это март.', '<br/>');
    month = 3;
}
if (dayTenTask >= 91 && dayTenTask < 121) {
    document.writeln('Это апрель.', '<br/>');
    month = 4;
}
if (dayTenTask >= 121 && dayTenTask < 152) {
    document.writeln('Это май.', '<br/>');
    month = 5;
}
if (dayTenTask >= 152 && dayTenTask < 182) {
    document.writeln('Это июнь.', '<br/>');
    month = 6;
}
if (dayTenTask >= 182 && dayTenTask < 213) {
    document.writeln('Это июль.', '<br/>');
    month = 7;
}
if (dayTenTask >= 213 && dayTenTask < 244) {
    document.writeln('Это август.', '<br/>');
    month = 8;
}
if (dayTenTask >= 244 && dayTenTask < 274) {
    document.writeln('Это сентябрь.', '<br/>');
    month = 9;
}
if (dayTenTask >= 274 && dayTenTask < 305) {
    document.writeln('Это октябрь.', '<br/>');
    month = 10;
}
if (dayTenTask >= 305 && dayTenTask < 335) {
    document.writeln('Это ноябрь.', '<br/>');
    month = 11;
}
if (dayTenTask >= 335 && dayTenTask < 365) {
