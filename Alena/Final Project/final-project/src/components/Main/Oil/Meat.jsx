  ...
  return (
    ...
    >
      ...
      onClick={() => {
        ...
        document.cookie = `product3=${JSON.stringify(countCookie)}; max-age=${age}`;
        editCart();
      }}
        style={{
      ...
      <Overlay target={target.current} show={show} placement="bottom" delay={{ show: 250, hide: 400 }}>
        {(props) => (
          <Tooltip className="tooltip tooltip-bottom" {...props}>
